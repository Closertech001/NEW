...
from sentence_transformers import SentenceTransformer, utilimport streamlit as st
...
@st.cache_resource
def compute_embeddings(model, questions: list):
...
question_embeddings = compute_embeddings(model, question_list)
